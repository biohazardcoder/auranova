...
export const Movie = () => {
    ...
    const { data, isLoading, error } = useSWR(`/movie?page=${page}&limit=${limit}`, fetcher);
                    ...
                    {isLoading || !data ? (
                        ...
                        <>
                            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 w-full min-h-[40vh] p-4">
                                {data.movies.map(({ images, title, made, _id }: MovieProps) => (
                                    <div
                                        key={_id}
                        ...
                        <div className="text-center mt-10">Filmlar topilmadi</div>
                    )}
                </div>
            </div>
        </div>
