...
export const Drama = () => {
    ...
    const { data, isLoading, error } = useSWR(`/drama?page=${page}&limit=${limit}`, fetcher);
                    ...
                    {isLoading || !data ? (
                        ...
                        <>
                            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 w-full min-h-[40vh] p-4">
                                {data.dramas.map(({ images, title, made, _id }: DramaProps) => (
                                    <div
                                        key={_id}
                        ...
                        <div className="text-center mt-10">Dramalar topilmadi</div>
                    )}
                </div>
            </div>
        </div>
