...
export function AddAnimePart({ id }: { id: string }) {
  ...
  const { mutate } = useSWR(`/anime/${id}`, fetcher)
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await axios.post("http://localhost:4000/api/anime/part", body, {
        headers: {
